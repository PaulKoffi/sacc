...
import sacc.statistiques.basicsStatistiques.subscribers.NumberOfPositionChangementSub;
...
public class NumberOfPositionChangementStatistique extends HttpServlet {
    ...
    private NumberOfPositionChangementSub numberOfPositionChangementSub = new NumberOfPositionChangementSub();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String topicId = "numberOfPositionChangementStats";
        ...
        try {
            ...
            numberOfPositionChangementSub.subscribeAsyncExample(projectId);
